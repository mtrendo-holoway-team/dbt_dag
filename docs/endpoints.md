...
- `GET /inspector/node/{node_id}`: Render the selected node inspector shell partial with tokenized HTMX block placeholders.
- `GET /inspector/node/{node_id}/model-info`: Render the model info inspector block.
- `GET /inspector/node/{node_id}/description`: Render the description inspector block.
